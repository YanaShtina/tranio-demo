...
;// CONCATENATED MODULE: ./node_modules/swiper/swiper-bundle.js
/**
 * Swiper 9.4.1
...
/* harmony default export */ var slider = ({
  init: function init() {
    ...
    var sliderBig = document.querySelectorAll('.project__slider-big');
    sliderBig.forEach(function (el) {
      var sliderSmall = el.closest(".project__slider").querySelector('.project__slider-small');
      var swiper_thumbnail = new Swiper(sliderSmall, {
        slidesPerView: 'auto',
        spaceBetween: 10,
